        ...
        <div class="col-md-4 col-md-offset-4" style="margin-top: 20px">
            ...
            <form action="{{ route('register-user') }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-controll" placeholder="Enter Full Name" name="name" value="{{ old('name') }}">
                ...
                <div class="form-group">
                    <button class="btn btn-block btn-primary" style="margin-top: 10px" type="submit">Register</button>
                </div>
